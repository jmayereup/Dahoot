    ...
    <div className="app-container">
      <div className="panel panel-large animate-join-focus" style={{ textAlign: 'left' }}>
        <div style={{ marginBottom: 24 }}>
          <h2>Import from Gemini</h2>
          <p style={{ color: 'var(--text-secondary)', marginBottom: 8 }}>
            Paste the JSON array generated by Google Gemini below to load questions into: <strong>{selectedGame?.title}</strong>
          </p>
          <p style={{ margin: 0, fontSize: '0.9rem', display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            >
              💎 Open Dahoot Quiz Generator Gem
            </a>
            ...
            >
              📖 View JSON format guide & prompt template
            </a>
          </p>
        </div>
